...
export const DEFAULT_CMS = {
  ...
  hero: {
    ...
    subtext: 'Connect with clients actively searching for interior designers. Purchase individual verified leads — no subscription, no lock-in.',
    cta1: 'Browse Leads',
    cta2: 'Join as Designer',
    socialProof: 'Trusted by 1,200+ designers',
    stat1Value: '2,400+', stat1Label: 'Monthly Leads',
    stat2Value: '48', stat2Label: 'Active Cities',
    stat3Value: '₹45Cr+', stat3Label: 'Project Value',
  },
  stats: [
    { value: '2,400+', label: 'Monthly Leads' },
    { value: '48', label: 'Active Cities' },
    { value: '4 min', label: 'Avg. Alert Time' },
    { value: '₹45Cr+', label: 'Project Value' },
  ],
  howItWorks: {
    tag: 'How It Works',
